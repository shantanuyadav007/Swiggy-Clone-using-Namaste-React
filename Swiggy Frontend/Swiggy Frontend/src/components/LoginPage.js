...
const LoginPage = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8 w-4/12 border shadow-sm ">
      ...
      <Link to="/">
        <button className = "Log-In button bg-orange-600 w-48 h-10 rounded-lg  hover:bg-orange-300 text-white font-Inter ml-20 mt-5">
          Proceed to order
        </button>
      </Link>
    </div>
          ...
          <div className="mt-8 space-y-6">
            ...
            <div>
              <button
                type="button"
                onClick={handleLogin}
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-orange-600 hover:bg-orange-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Login
              </button>
            </div>
